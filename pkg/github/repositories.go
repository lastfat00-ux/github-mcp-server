...
// sanitizeRelease sanitizes untrusted user content in a GitHub release object (Name, Body)
// as defense-in-depth against XSS vulnerabilities in downstream clients rendering LLM outputs.
