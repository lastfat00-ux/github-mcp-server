...
func searchHandler(
	...
	// Sanitize titles, bodies, and repository descriptions
	for _, issue := range result.Issues {
		...
		if issue.Repository != nil && issue.Repository.Description != nil {
			issue.Repository.Description = github.Ptr(sanitize.Sanitize(*issue.Repository.Description))
		}
	}
