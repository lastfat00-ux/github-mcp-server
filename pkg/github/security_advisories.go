...
// sanitizeSecurityAdvisory sanitizes the user-controlled fields of a SecurityAdvisory.
// This is a defense-in-depth measure to prevent XSS payloads from propagating to downstream
// LLM-based clients that render markdown/HTML directly.
...
// sanitizeGlobalSecurityAdvisory sanitizes the wrapped SecurityAdvisory within a GlobalSecurityAdvisory.
// This is a defense-in-depth measure to prevent XSS payloads from propagating to downstream
// LLM-based clients that render markdown/HTML directly.
func sanitizeGlobalSecurityAdvisory(gsa *github.GlobalSecurityAdvisory) {
	if gsa == nil {
		return
	}
	sanitizeSecurityAdvisory(&gsa.SecurityAdvisory)
}
