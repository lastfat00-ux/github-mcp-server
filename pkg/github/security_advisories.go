	...
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			for _, adv := range advisories {
				sanitizeGlobalSecurityAdvisory(adv)
			}
...
func sanitizeSecurityAdvisory(adv *github.SecurityAdvisory) {
	...
	if adv.Summary != nil {
		adv.Summary = github.Ptr(sanitize.Sanitize(*adv.Summary))
	}
	if adv.Description != nil {
		adv.Description = github.Ptr(sanitize.Sanitize(*adv.Description))
	}
}
...
func sanitizeGlobalSecurityAdvisory(adv *github.GlobalSecurityAdvisory) {
	...
	sanitizeSecurityAdvisory(&adv.SecurityAdvisory)
}
