...
func ListNotifications(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// Sanitize notifications for Defense in Depth against XSS in downstream clients
...
func GetNotificationDetails(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// Sanitize notification details for Defense in Depth against XSS in downstream clients
...
// sanitizeNotification sanitizes notification fields (such as Subject.Title) using pkg/sanitize.Sanitize.
// This provides Defense in Depth against XSS for downstream clients rendering markdown or HTML.
