...
func ListNotifications(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// Defense in Depth: Sanitize notification titles using pkg/sanitize.Sanitize to protect downstream LLM-based clients that render markdown/HTML directly.
...
func GetNotificationDetails(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// Defense in Depth: Sanitize notification title using pkg/sanitize.Sanitize to protect downstream LLM-based clients that render markdown/HTML directly.
