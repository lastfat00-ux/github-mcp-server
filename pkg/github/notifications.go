...
// sanitizeNotification sanitizes untrusted user content in notification fields to prevent XSS.
// Defense in Depth: Downstream LLM-based clients and web UI hosts may render notification titles directly as HTML or Markdown.
