...
func GetSecretScanningAlert(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// nolint:gosec // intentional: marshal secret scanning alert which contains "Secret" field
...
func ListSecretScanningAlerts(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// nolint:gosec // intentional: marshal secret scanning alerts which contain "Secret" fields
