...
func ListGists(t translations.TranslationHelperFunc) inventory.ServerTool {
	return NewTool(
		...
		func(ctx context.Context, deps ToolDependencies, _ *mcp.CallToolRequest, args map[string]any) (*mcp.CallToolResult, any, error) {
			...
			// Sanitize description on each gist to prevent XSS from untrusted user content
			// Defense in Depth design choice: protect downstream LLM-based clients that render markdown/HTML directly
			for _, g := range gists {
